...
const Vision = () => {
    return (
        <div className='vision-container py-[130px] flex justify-evenly sm:gap-10'>
            <div className="vision-card w-[42%] sm:w-[90%]" data-aos="fade-right">
                <div className="vision-header font-bold text-[42px] text-[#387F39] text-center">AIFBF VISION</div>
                <p className="pt-5 text-[#696e77] sm:pt-2">
            ...
            <div className="vision-card w-[42%] sm:w-[90%]" data-aos="fade-left">
