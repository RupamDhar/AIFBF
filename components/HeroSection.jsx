        ...
        <div className='hero-section flex sm-max:flex-col p-[80px_25px_50px] sm-max:p-[50px_25px]' data-aos="fade-up">
            <div className="hero-content flex flex-col justify-center items-center gap-5">
                <div className="hero-info w-full h-fit">
                    <div className="hero-sub-header text-[20px] sm-max:text-[18px] pb-3 text-[#FF885B] text-center">
                ...
                <div className="flex justify-center contact-btn text-center px-5 py-2 text-white rounded-xl font-bold bg-[#387F39] min-w-[160px] leading-[26px]">
                ...
                <ul className="list_box flex flex-wrap justify-center sm-max:w-full">
                    <li className='w-fit mb-[15px] p-[5px]'>
                        <div className="flex gap-2 w-fit">
                            ...
                            <a className="links text-[#0f3567]" href="#">
